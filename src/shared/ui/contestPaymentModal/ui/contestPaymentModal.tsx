...
export const ContestPaymentModal = ({isOpen, setIsOpen}: ContestPaymentModalProps) => {
   
    return(
        <ModalWindow
        isOpen={isOpen}
        // className='payment_classname'
        // overlayClassName='payment_overlayClassname'
        modalContentClass='paymentModal'>
        {/* <VStack className='paymentModal__content'> */}
            <HStack className='paymentModal__content__header'>
                <HStack className="paymentModal__content__header__icontextContainer">
                <Icon Svg={alert} className="paymentModal__content__header__icontextContainer__alertIcon"/>
                <Text Tag='h3' className='paymentModal__content__header__icontextContainer__text'>
                Top up your balance
                </Text>
                </HStack>
                <Icon
            ...
            <VStack className="paymentModal__body">
                <HStack className="paymentModal__body__iconWrapper">
                    <Icon Svg={wallet} className="paymentModal__body__icon" width={56} height={56}/>
                </HStack>

                <Text Tag="p" className="paymentModal__body__boldText">There is currently not enough money in your account to cover<br/>the competition prize fund</Text>

                <VStack className="paymentModal__body__balanceInfo">
                    <Text Tag="p" className="paymentModal__body__balanceInfo__text">Account information in balance</Text>
                </VStack>

                <Text Tag="p" className="paymentModal__body__text">Please fund your account or change the prize amount in the competition</Text>
            </VStack>
